...
@REM if %CC% equ "tcc"
    @REM set INPUT=TicTac.c src/game.c  src/board.c src/control.c src/menu.c src/leaderboard.c
    @REM set FLAGS= -Wall -Wextra -g 
    @REM set I_PATH=-I./src -I./lib/raylib/include
    @REM set L_PATH=-L./lib/raylib/lib
    @REM set LIBS=-lraylib -lopengl32 -lgdi32 -lwinmm
